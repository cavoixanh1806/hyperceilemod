...
6. **Detailed Architecture**: Refer to [.agents/knowledge/hypercvx_clock_mod_workflow.md](file:///d:/DEV/UnlockBootloader/root/n/.agents/knowledge/hypercvx_clock_mod_workflow.md) for full layout rules and drawable factory details.
