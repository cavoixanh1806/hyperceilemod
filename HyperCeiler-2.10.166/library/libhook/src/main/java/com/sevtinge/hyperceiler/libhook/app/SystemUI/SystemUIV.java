...
import com.sevtinge.hyperceiler.libhook.rules.systemui.statusbar.clock.ZkClockStyleHook;
...
public class SystemUIV extends BaseLoad {
    ...
    public void onPackageLoaded() {
        ...
        boolean isZkClockEnabled = PrefsBridge.getBoolean("system_ui_statusbar_zk_clock_style_enable");
        initHook(StatusBarClockNew.INSTANCE, PrefsBridge.getBoolean("system_ui_statusbar_clock_all_status_enable") && !isZkClockEnabled);
        initHook(ZkClockStyleHook.INSTANCE, isZkClockEnabled);
        //
        // // 硬件指示器
